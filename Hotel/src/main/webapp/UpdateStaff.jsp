...
<div class="hero-section">
  <form action="UpdateStaffServlet" method="post" class="abc">
    <h3 class="text-center mb-4">Update Staff</h3>

                  <div class="row mb-3">
                <div class="col-md-4">
                        <label>Enter the Staff ID Number which you want to Update Staff</label>
    ...
    <div class="mb-3">
      ...
      <input type="text" name="firstName" class="form-control" required placeholder = "New First Name">
    </div>
    ...
    <div class="mb-3">
      <label class="form-label">Hire Date (Update Date)</label>
