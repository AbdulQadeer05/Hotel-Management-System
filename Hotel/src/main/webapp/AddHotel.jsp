            ...
            <form action="Addhotel" method="post">
                <div class="row mb-3">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="name" class="form-control" placeholder="Hotel Pearl Continental" required>
                    </div>
                    <div class="col-md-6">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" name="address" class="form-control" placeholder="Street, Area, Landmark" required>
                </div>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" class="form-control" rows="3" placeholder="Short hotel description..."></textarea>
                </div>

                <button type="submit" class="btn btn-custom w-100 mt-3">Register Hotel</button>
            </form>
        </div>
    </div>
</body>
