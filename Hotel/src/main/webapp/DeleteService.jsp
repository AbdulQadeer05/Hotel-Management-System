...
<div class="hero-section">
  <form action="DeleteService" method="post" class="abc">
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label text-light">Enter the Service ID which you want to Delete</label>
