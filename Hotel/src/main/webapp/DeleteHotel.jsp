...
<div class="hero-section">
  <form action="DeleteHotel" method="post" class="abc">
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label text-light">Enter the hotel ID which you want to Delete</label>
